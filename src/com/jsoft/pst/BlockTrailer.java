...
*
*	@see	"[MS-PST] Outlook Personal Folders (.pst) File Format v20110608 Section 2.2.2.8"
*	@see	<a href="http://msdn.microsoft.com/en-us/library/ff387040(v=office.12).aspx">BLOCKTRAILER (MSDN)</a>
*/
class BlockTrailer {
