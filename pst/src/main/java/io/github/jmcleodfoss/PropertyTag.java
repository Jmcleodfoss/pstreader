...
public class PropertyTag {
	...
	public static final int ResourceAttendees = makeTag(PropertyID.ResourceAttendees, DataType.STRING);
	public static final int DelegateMail = makeTag(PropertyID.DelegateMail, DataType.BOOLEAN);
	public static final int IsException = makeTag(PropertyID.IsException, DataType.BOOLEAN);
	public static final int TimeZone = makeTag(PropertyID.TimeZone, DataType.INTEGER_32);
	public static final int StartRecurrenceDate = makeTag(PropertyID.StartRecurrenceDate, DataType.INTEGER_32);
	public static final int StartRecurrenceTime = makeTag(PropertyID.StartRecurrenceTime, DataType.INTEGER_32);
	public static final int DeferredDeliveryTime = makeTag(PropertyID.DeferredDeliveryTime, DataType.TIME);
	public static final int EndRecurrenceTime = makeTag(PropertyID.EndRecurrenceTime, DataType.INTEGER_32);
	public static final int DayInterval = makeTag(PropertyID.DayInterval, DataType.INTEGER_16);
	public static final int MonthInterval = makeTag(PropertyID.MonthInterval, DataType.INTEGER_16);
	public static final int WeekInterval = makeTag(PropertyID.WeekInterval, DataType.INTEGER_16);
	public static final int YearInterval = makeTag(PropertyID.YearInterval, DataType.INTEGER_16);
	...
	public static final int OldRecurrenceType = makeTag(PropertyID.OldRecurrenceType, DataType.INTEGER_16);
	...
	public static final int OldWhenEndWhole = makeTag(PropertyID.OldWhenEndWhole, DataType.TIME);
	...
	public static final int OriginalSenderEntryId = makeTag(PropertyID.OriginalSenderEntryId, DataType.BINARY);
	...
	public static final int AttachSize = makeTag(PropertyID.AttachSize, DataType.INTEGER_32);
	...
	public static final int RtfSyncBodyTag = makeTag(PropertyID.RtfSyncBodyTag, DataType.STRING_8);
	public static final int RtfSyncBodyTagW = makeTag(PropertyID.RtfSyncBodyTag, DataType.STRING);
	...
	public static final int BodyHtmlW = makeTag(PropertyID.BodyHtml, DataType.STRING);
	...
	*/
	...
	public static final int AttachAdditionalInformation = makeTag(PropertyID.AttachAdditionalInformation, DataType.BINARY);
	...
	public static final int AddressBookDisplayNamePrintable = makeTag(PropertyID.AddressBookDisplayNamePrintable, DataType.STRING);
	public static final int Account = makeTag(PropertyID.Account, DataType.STRING);
	public static final int CallbackTelephoneNumber = makeTag(PropertyID.CallbackTelephoneNumber, DataType.STRING);
	...
	public static final int Business2TelephoneNumber = makeTag(PropertyID.Business2TelephoneNumber, DataType.STRING_8);
	public static final int Business2TelephoneNumberW = makeTag(PropertyID.Business2TelephoneNumber, DataType.STRING);
	...
	public static final int RadioTelephoneNumber = makeTag(PropertyID.RadioTelephoneNumber, DataType.STRING_8);
	public static final int RadioTelephoneNumberW = makeTag(PropertyID.RadioTelephoneNumber, DataType.STRING);
	public static final int CarTelephoneNumber = makeTag(PropertyID.CarTelephoneNumber, DataType.STRING_8);
	public static final int CarTelephoneNumberW = makeTag(PropertyID.CarTelephoneNumber, DataType.STRING);
	...
	public static final int PagerTelephoneNumber = makeTag(PropertyID.PagerTelephoneNumber, DataType.STRING_8);
	public static final int PagerTelephoneNumberW = makeTag(PropertyID.PagerTelephoneNumber, DataType.STRING);
	...
	public static final int TelexNumber = makeTag(PropertyID.TelexNumber, DataType.STRING_8);
	public static final int TelexNumberW = makeTag(PropertyID.TelexNumber, DataType.STRING);
	public static final int TelexNumberNspi = makeTag(PropertyID.TelexNumber, DataType.MULTIPLE_BINARY);
	public static final int IsdnNumber = makeTag(PropertyID.IsdnNumber, DataType.STRING_8);
	public static final int IsdnNumberW = makeTag(PropertyID.IsdnNumber, DataType.STRING);
	public static final int AssistantTelephoneNumber = makeTag(PropertyID.AssistantTelephoneNumber, DataType.STRING_8);
	public static final int AssistantTelephoneNumberW = makeTag(PropertyID.AssistantTelephoneNumber, DataType.STRING);
	public static final int Home2TelephoneNumber = makeTag(PropertyID.Home2TelephoneNumber, DataType.STRING_8);
	public static final int Home2TelephoneNumberW = makeTag(PropertyID.Home2TelephoneNumber, DataType.STRING);
	...
	public static final int TelecommunicationsDeviceForDeafTelephoneNumber = makeTag(PropertyID.TelecommunicationsDeviceForDeafTelephoneNumber, DataType.STRING_8);
	public static final int TelecommunicationsDeviceForDeafTelephoneNumberW = makeTag(PropertyID.TelecommunicationsDeviceForDeafTelephoneNumber, DataType.STRING);
	...
	public static final int CompanyMainTelephoneNumber = makeTag(PropertyID.CompanyMainTelephoneNumber, DataType.STRING_8);
	public static final int CompanyMainTelephoneNumberW = makeTag(PropertyID.CompanyMainTelephoneNumber, DataType.STRING);
	...
	public static final int SendInternetEncoding = makeTag(PropertyID.SendInternetEncoding, DataType.INTEGER_32);
	...
	public static final int FolderId32 = makeTag(PropertyID.FolderId32, DataType.INTEGER_32);
	...
	public static final int OfflineAddressBookDistinguishedName = makeTag(PropertyID.OfflineAddressBookDistinguishedName, DataType.STRING_8);
	public static final int OfflineAddressBookTruncatedProperties = makeTag(PropertyID.OfflineAddressBookTruncatedProperties, DataType.MULTIPLE_INTEGER_32);
	...
	public static final int SearchFolderTag = makeTag(PropertyID.SearchFolderTag, DataType.INTEGER_32);
	...
	public static final int AttachmentContactPhoto = makeTag(PropertyID.AttachmentContactPhoto,  DataType.BOOLEAN);
	...
	public static final int FileUnderId = makeTag(PropertyID.FileUnderId, DataType.INTEGER_32);
	...
	public static final int AddressBookIsMemberOfDistributionListNspi = makeTag(PropertyID.AddressBookIsMemberOfDistributionListNspi, DataType.MULTIPLE_STRING);
	...
	public static final int FExceptionalAttendees = makeTag(PropertyID.FExceptionalAttendees, DataType.BOOLEAN);
	...
	public static final int RecurrenceType = makeTag(PropertyID.RecurrenceType, DataType.INTEGER_32);
	...
	public static final int AutoFillLocation = makeTag(PropertyID.AutoFillLocation, DataType.BOOLEAN);
