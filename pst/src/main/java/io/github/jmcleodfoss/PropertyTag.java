...
public class PropertyTag {
	...
	*/
	...
	public static final int RadioTelephoneNumber = makeTag(PropertyID.RadioTelephoneNumber, DataType.STRING);
	public static final int RadioTelephoneNumberW = makeTag(PropertyID.RadioTelephoneNumber, DataType.STRING_8);
	public static final int CarTelephoneNumber = makeTag(PropertyID.CarTelephoneNumber, DataType.STRING);
	public static final int CarTelephoneNumberW = makeTag(PropertyID.CarTelephoneNumber, DataType.STRING_8);
	public static final int OtherTelephoneNumber = makeTag(PropertyID.OtherTelephoneNumber, DataType.STRING);
	public static final int OtherTelephoneNumberW = makeTag(PropertyID.OtherTelephoneNumber, DataType.STRING_8);
	public static final int PagerTelephoneNumber = makeTag(PropertyID.PagerTelephoneNumber, DataType.STRING);
	public static final int PagerTelephoneNumberW = makeTag(PropertyID.PagerTelephoneNumber, DataType.STRING_8);
	...
	public static final int AssistantTelephoneNumberW = makeTag(PropertyID.AssistantTelephoneNumber, DataType.STRING_8);
